function Kicks(id, name, category, image,description, quantity, price){
    this.id = id;
    this.name = name;
...
const item1 = new Kicks(1, '', 'Shoes', 
    ...
    1,29.99);
const item2 = new Kicks(2, '', 'Clothing', 'https://c0dingforfun.github.io/kicksPics/Images/Nike/Men/Air_Force1(Black).png',
     'Slim-fit denim jeans for men, made with premium cotton',1, 49.99);
const item3 = new Kicks(3, '', 'Electronics', 'https://c0dingforfun.github.io/kicksPics/Images/Nike/Men/Air_Force1(Black).png', 
    'Noise-canceling wireless beats headphones with up to 20 hours of battery life',1, 129.99);
const item4 = new Kicks(4, '', 'Books', 'https://c0dingforfun.github.io/kicksPics/Images/Nike/Men/Air_Force1(Black).png',
     'The latest bestselling novel by a renowned author',1, 14.99);
const item5 = new Kicks(5, '', 'Clothing', 'https://c0dingforfun.github.io/kicksPics/Images/Nike/Men/Air_Force1(Black).png',

...
function nikeKicks(id, gender, name, image, description, quantity, price){
  ...
  this.price = price;
    ...
    const nMen1 = new nikeKicks(1, 'Men', 'Air Force 1',
        ...
        1,1700);
    const nMen2 = new nikeKicks(2, 'Men', 'KD17 Sunrise',
        ...
        1,1400);
    const nMen3 = new nikeKicks(3, 'Men', 'Air Max',
        ...
        1,1300);
    const nWomen1 = new nikeKicks(4, 'Women', 'Air Force 1',
        ...
        'The radiance lives on in the Air Force 1 07, the b-ball icon that puts a fresh spin on what you know best: crisp materials, bold colours and the perfect amount of flash to make you shine.',
         1,1500);
    const nWomen2 = new nikeKicks(5, 'Women', 'Air Max',
        ...
        'With its easy-going lines, heritage athletics look and, of course, visible Air cushioning, the Nike Air Max SC is the perfect finish to any outfit. The rich mixture of materials adds depth while making it a durable and lightweight shoe for everyday wear.',
         1,1300);
    const nWomen3 = new nikeKicks(6, 'Women', 'GT-Cut Cross',
...
function pumaKicks(id, gender, name, image, description, quantity, price){
    ...
    const pMen1 = new pumaKicks(1, 'Men', 'Slipstream Leather',
        ...
        'Back in 1987, the PUMA Slipstream Mid entered the scene as a basketball sneaker. A high-flying, slam-dunking, statement-making basketball sneaker. Now, it’s joined by the Slipstream – a rework of the original that brings an all-new energy to the game while staying true to the OG’s sporting roots.',
         1,1600);
    const pMen2 = new pumaKicks(2, 'Men', 'Caven Mid',
        'https://c0dingforfun.github.io/kicksPics/Images/Puma/Men/Caven_Mid.png',
         ...
         1,1300);
    const pMen3 = new pumaKicks(3, 'Men', 'RBD Game',

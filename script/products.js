...
function pumaKicks(id, brand, name, image, description, quantity, price){
    ...
    const pWomen1 = new pumaKicks(4, 'Puma', 'Lajla_Leather(Women)',
        'https://c0dingforfun.github.io/kicksPics/Images/Puma/Women/Lajla_Leather.png',
         'Classic design, fresh new direction. These Lajla Leather Women‘s Sneakers exude style. With a streamlined all-over look, these sneakers are supremely comfortable and can be paired with anything. The subtle metallic PUMA No. 2 Logo speaks to this sneaker‘s quality.',
          1,1240);
    ...
    const pWomen3 = new pumaKicks(6, 'Puma', 'Mayze OW(Women)',
        'https://c0dingforfun.github.io/kicksPics/Images/Puma/Women/Mayze_OW.png',
         'For the hype girls, the street enthusiasts, the trend setters ­­– the Mayze. This stand-out model has a stacked sole for a look that makes a statement, however you choose to style it.', 
         1,1125);
        ...
        nProducts.innerHTML += `
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button value="${nike.id}" class="purchNikes">Add To Cart</button>
